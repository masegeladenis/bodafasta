...
<head>
<meta charset="UTF-8">
<title>Bodafasta - Revolutionizing Motorcycle Transportation in Tanzania</title>
<meta name="description" content="Bodafasta is a Tanzanian transportation company revolutionizing the bodaboda sector through technology, safety, and sustainable employment. Invest in the future of urban mobility."/>
...
<div class="page-wrapper">
			...
			<div class="slide" data-bg-image="images/main-slider/intro-1.jpg">
				<div class="auto-container w-100">
					<div class="row clearfix">
						...
						<div class="content-column col-lg-7 col-md-12 col-sm-12">
							<div class="inner-column">
								<div class="title">Bodafasta App</div>
				...
				<div class="row align-items-center clearfix">
					...
					<div class="content-column col-lg-6 col-md-12 col-sm-12 mb-0">
						<div class="about-column">
							<div class="sec-title">
								<div class="title">About Bodafasta</div>
	...
	<!-- Financial Projections / Testimonial Section -->
	<div class="testimonial-section">
		<div class="auto-container">
			<!-- Sec Title -->
			<div class="sec-title">
				<div class="title">financial projections</div>
				<h2><span>Proven Growth</span> Potential</h2>
			</div>
	...
	<!-- End Financial Projections Section -->
		...
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="content-column col-lg-7 col-md-12 col-sm-12">
					<div class="inner-column">
						<div class="sec-title">
							<div class="title">why invest in bodafasta</div>
							<h2><span>Competitive </span>Advantages<br> That Set Us Apart</h2>
						</div>
						<div class="blocks-outer">
							...
							<div class="reputation-block">
								<div class="inner-box">
								<h5>Asset Ownership</h5>
									<div class="text">Unlike competitors, Bodafasta owns its fleet, ensuring better control <br> and revenue stability across all operations.</div>
								</div>
							</div>
							...
							<div class="reputation-block">
								<div class="inner-box">
									...
									<div class="text">Real-time GPS tracking, cashless payments via mobile money, <br> and a user-friendly app interface for seamless service.</div>
								</div>
							</div>
							...
							<div class="reputation-block">
								<div class="inner-box">
									<h5>Driver Welfare &amp; Training</h5>
									<div class="text">Drivers receive professional training, insurance, health support, <br> and fair employment terms ensuring loyalty and quality service.</div>
								</div>
							</div>
	...
	<div class="blog-section">
		<div class="auto-container">
			...
			<div class="sec-title centered">
				...
				<h2><span>Phased </span>Growth Strategy</h2>
			</div>
			<div class="inner-container">
