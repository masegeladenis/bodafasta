			...
			<div class="row clearfix">
				...
				<div class="team-block col-lg-4 col-md-6 col-sm-6 col-12">
					<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-box mt-0">
							<h4><a href="#">Operations Lead</a></h4>
							<div class="designation">Fleet & Logistics Manager</div>
						</div>
					</div>
				</div>
				...
				<div class="team-block col-lg-4 col-md-6 col-sm-6 col-12">
					<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<div class="lower-box mt-0">
							<h4><a href="#">Technology Lead</a></h4>
							<div class="designation">App & Platform Development</div>
						</div>
					</div>
				</div>
